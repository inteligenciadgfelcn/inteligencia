...
export const FormularioOperativo = () => {
  ...
  const addBienItem = () => {
    ...
    const newBien = {
      ...
      fotografiaUrl: fotografiaFile
        ? URL.createObjectURL(fotografiaFile)
        : null,
    }
    ...
    <>
      <Card title="DATOS GENERALES">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <FormInputText
            id="quienRealiza"
            name="quienRealiza"
            label="Quien Realiza la Solicitud"
            control={control}
          />
          <FormInputText
            id="celularRealiza"
          ...
          <FormInputText
            id="asignado"
            name="asignado"
            label="Asignado al Caso"
            control={control}
          />
          <FormInputText
            id="celularAsignado"
            name="celularAsignado"
            label="Nro. Celular"
            control={control}
          />
          <div className="hidden lg:block"></div>
          ...
          <div className="col-span-1 lg:col-span-3 mt-4">
            <MapaConMarcador
              ...
              coordenadas={
                latitud && longitud ? [Number(latitud), Number(longitud)] : null
              }
            />
          </div>
      ...
      <Card title="SUSTANCIAS QUIMICAS CONTROLADAS SOLIDAS" className="mt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <FormInputDropdown
            ...
            control={control}
            options={[
              { id: 'sustancia1', label: 'Seleccione un Dato', value: '' },
            ]}
          />
          <FormInputText
            id="sustanciaQuimicaSolidaCantidad"
            name="sustanciaQuimicaSolidaCantidad"
            label="Cantidad"
            control={control}
          />
          <FormInputText
            id="sustanciaQuimicaSolidaKilos"
            name="sustanciaQuimicaSolidaKilos"
            label="Kilos"
            control={control}
          />
          <FormInputText
            id="sustanciaQuimicaSolidaGramos"
            name="sustanciaQuimicaSolidaGramos"
            label="Gramos"
            control={control}
          />
      ...
      <Card title="SUSTANCIAS QUIMICAS CONTROLADAS LIQUIDAS" className="mt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          />
          <FormInputText
            id="sustanciaQuimicaLiquidaCantidad"
            name="sustanciaQuimicaLiquidaCantidad"
            label="Cantidad"
            control={control}
          />
          <FormInputText
            id="sustanciaQuimicaLitros"
            name="sustanciaQuimicaLitros"
            label="Litros"
            control={control}
          />
          <FormInputText
            id="sustanciaQuimicaMililitros"
            name="sustanciaQuimicaMililitros"
            label="Mililitros"
            control={control}
          />
      ...
      {/* PERSONAS SECTION */}
      <Card
        title="PERSONAS: PRINCIPAL IMPLICADO / APREHENDIDAS / ARRESTADAS / LGI O PERDIDA DE DOMINIO"
        className="mt-5"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {/* Row 1 */}
          ...
          <FormInputText
            id="personaApPaterno"
            name="personaApPaterno"
            label="Ap. Paterno"
            control={control}
          />
          <FormInputText
            id="personaApMaterno"
            name="personaApMaterno"
            label="Ap. Materno"
            control={control}
          />
          <FormInputText
            id="personaApEsposo"
            name="personaApEsposo"
            label="Ap. Esposo"
            control={control}
          />
          ...
          />
          <FormInputText
            id="personaNumeroDocumento"
            name="personaNumeroDocumento"
      ...
      <Card title="BIENES U OBJETOS SECUESTRADOS" className="mt-5">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <FormInputDropdown
            ...
            options={[
              {
                id: 'municion-arma-corta',
                label: 'Municion Arma Corta',
                value: 'municion_arma_corta',
              },
          ...
          <div className="col-span-1 lg:col-span-3 flex justify-end mt-4">
            <Button variant="danger" type="button" onClick={addBienItem}>
              Agregar Bien
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <FormInputDropdown
            ...
            options={[
              {
                id: 'horizontal',
                label: 'Fotografia Horizontal',
                value: 'horizontal',
              },
              {
                id: 'vertical',
                label: 'Fotografia Vertical',
                value: 'vertical',
              },
              {
                id: 'cuadrada',
                label: 'Fotografia Cuadrada',
                value: 'cuadrada',
              },
            ]}
          />
          ...
          <div className="col-span-1 lg:col-span-3 flex justify-end mt-4">
            <Button variant="danger" type="button" onClick={addGaleriaItem}>
              Agregar a Galeria
            </Button>
          </div>
                  ...
                  },
                  {
                    ...
                    render: (row) => (
                      <button
                        type="button"
                        className="text-danger"
                        onClick={() => deleteGaleriaItem(row.id)}
                      >
                        <IconTrashLines />
                      </button>
                    ),
