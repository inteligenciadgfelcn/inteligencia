...
export function useParametricas() {
    ...
    const [categoriasOperativo, setCategoriasOperativo] = useState<LookupBasico[]>([])
    ...
    const [etapasInvestigacion, setEtapasInvestigacion] = useState<LookupBasico[]>([])
    const [recursos, setRecursos] = useState<LookupBasico[]>([])
    const [sustanciasSolidasDesc, setSustanciasSolidasDesc] = useState<LookupBasico[]>([])
    const [sustanciasLiquidasDesc, setSustanciasLiquidasDesc] = useState<LookupBasico[]>([])
    ...
    const cargarPaisesPorContinente = useCallback(async (idContinente: number) => {
        setCargando(true)
        setPaises([])
        try {
            const res = await SiiiLookupsService.obtenerPaisesPorContinente(idContinente)
            if (res.finalizado) setPaises(res.datos)
        } finally {
            setCargando(false)
        }
    ...
    const cargarTiposPersona = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setTiposPersona(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarEstadosCiviles = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setEstadosCiviles(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarCategoriasOperativo = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setCategoriasOperativo(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarTiposFabrica = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setTiposFabrica(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarTiposDocumento = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setTiposDocumento(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarTiposImplicado = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setTiposImplicado(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarEtapasInvestigacion = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setEtapasInvestigacion(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarSustanciasSolidasDesc = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setSustanciasSolidasDesc(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarSustanciasLiquidasDesc = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setSustanciasLiquidasDesc(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarCocaProcedencias = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setCocaProcedencias(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarCocaDescripciones = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setCocaDescripciones(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarCalidadesBien = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setCalidadesBien(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarColoresCabello = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setColoresCabello(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
    ...
    const cargarTiposCabello = useCallback(async () => {
        ...
        try {
            ...
            if (res.finalizado) setTiposCabello(res.datos as unknown as LookupBasico[])
        } finally {
            setCargando(false)
        }
    }, [])
