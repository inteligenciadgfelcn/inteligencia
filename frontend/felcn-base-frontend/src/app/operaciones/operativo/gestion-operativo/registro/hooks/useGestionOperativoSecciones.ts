...
export function useSeccion1(idGestionOperativo: number, enabled = true) {
  const query = useQuery({
    ...
    queryFn: () =>
      GestionOperativosDatosGeneralesService.obtenerPorUsuario(
        idGestionOperativo
      ),
  ...
  const mutation = useMutation({
    mutationFn: (payload: any) =>
      GestionOperativosDatosGeneralesService.crearOperativo(
        idGestionOperativo,
        payload
      ),
  })
...
export function useSeccion3(
  ...
  const query = useQuery({
    ...
    queryFn: () =>
      GestionOperativoSustanciasSolidasService.listar(
        idGestionOperativo,
        page,
        limit
      ),
  ...
  const mutation = useMutation({
    mutationFn: (payload: any) =>
      GestionOperativoSustanciasSolidasService.crear(
        idGestionOperativo,
        payload
      ),
    onSuccess: () => {
...
export function useSeccion4(
  ...
  const query = useQuery({
    ...
    queryFn: () =>
      GestionOperativoSustanciasLiquidasService.listar(
        idGestionOperativo,
        page,
        limit
      ),
  ...
  const mutation = useMutation({
    mutationFn: (payload: any) =>
      GestionOperativoSustanciasLiquidasService.crear(
        idGestionOperativo,
        payload
      ),
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: number) =>
      GestionOperativoSustanciasLiquidasService.eliminar(
        idGestionOperativo,
        id
      ),
    onSuccess: () => {
...
export function useSeccion5(
  ...
  const query = useQuery({
    ...
    queryFn: () =>
      GestionOperativoLaboratorioService.listar(
        idGestionOperativo,
        page,
        limit
      ),
