      ...
      <div className="bg-gray-50 dark:bg-gray-800/40 p-4 rounded-lg border border-dashed border-gray-300 dark:border-gray-700">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-end">
          ...
          <div>
            ...
            <Input {...register('nombreApp', { required: true })} size="sm" />
          </div>
          <div>
            <label className="block text-xs font-medium mb-1">Teléfono Celular</label>
            <Input {...register('telefonoCelular')} size="sm" />
          </div>
          <div>
            <label className="block text-xs font-medium mb-1">Teléfono Fijo Unidad</label>
