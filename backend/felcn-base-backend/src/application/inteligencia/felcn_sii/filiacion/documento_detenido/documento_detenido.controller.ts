...
export class DocumentoDetenidoController {
  constructor(private readonly documentoDetenidoService: DocumentoDetenidoService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateDocumentoDetenidoDto: UpdateDocumentoDetenidoDto) {
