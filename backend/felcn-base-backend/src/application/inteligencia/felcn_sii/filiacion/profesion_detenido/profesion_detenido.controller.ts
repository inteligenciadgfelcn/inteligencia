...
export class ProfesionDetenidoController {
  constructor(private readonly profesionDetenidoService: ProfesionDetenidoService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateProfesionDetenidoDto: UpdateProfesionDetenidoDto) {
