import { Departamento } from '@/application/inteligencia/felcn_siii/parametricas/departamento/entities/departamento.entity'
import { Unidad } from '@/application/inteligencia/felcn_siii/parametricas/unidad/entities/unidad.entity'
import {
  Column,
  Entity,
  JoinColumn,
