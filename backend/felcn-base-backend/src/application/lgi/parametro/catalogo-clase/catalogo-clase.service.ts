...
export class CatalogoClaseLgiService {
  constructor(private readonly repository: CatalogoClaseLgiRepository) {}
  ...
  findAllClaseBien(idBien: number): Promise<any[]> {
    return this.repository.findAllByBien(idBien)
  }
}
