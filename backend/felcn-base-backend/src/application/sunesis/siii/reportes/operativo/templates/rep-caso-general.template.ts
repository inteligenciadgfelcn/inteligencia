...
export class CasoGralReportTemplate implements ReportTemplate<any> {
            ...
            <div class="main-content">
                <div class="section">
                    ...
                    <div class="timeline-item">
                        <div class="timeline-title">Relevancia: ${caso.relevanciaCaso || 'N/A'}</div>
                        <div class="timeline-title">CUD: ${caso.ianus || 'N/A'}</div>
                        <div class="timeline-title">Número de caso: ${caso.numeroCaso || 'N/A'}</div>
                        <div class="timeline-title">Número de caso de pérdida de dominio: ${caso.numeroCasoPerDom || 'N/A'}</div>
                       <div class="timeline-title">Numero de Operativo: ${caso.numeroOperativo || 'N/A'}</div>
                        ...
                        <div class="timeline-title">Tipo de Denuncia: ${operativo.descripcionTipoDenuncia || 'N/A'}</div>
                        <div class="timeline-title">Tipo Penal: ${operativo.descripcionTipoPenal || 'N/A'}</div>
                        <div class="timeline-title">Organización Criminal: ${operativo.organizacionCriminal || 'N/A'}</div>
                        <div class="timeline-title">Clan Familiar: ${operativo.clanFamiliar || 'N/A'}</div>
                        <div class="timeline-title">Coordenadas: (${operativo.coordX || 'N/A'}, ${operativo.coordY || 'N/A'})</div>
                    </div>
                </div>
                <div class="section">
                ...
                <div class="section">
                    ...
                    <div class="timeline-item">
                        ...
                        <table>
                            <thead><tr><th>Logo/Imagen</th><th>Descripción</th><th>Tipo de Droga</th><th>País de Origen</th><th>País de Destino</th><th>Organización</th><th>Implicados</th><th>Observación</th><th>Fotografía</th></tr></thead>
