...
export class FenotipoDetenidoController {
  constructor(private readonly fenotipoDetenidoService: FenotipoDetenidoService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateFenotipoDetenidoDto: UpdateFenotipoDetenidoDto) {
