...
/**
 * Política backend para el nuevo endpoint de desbloqueo manual de usuario
 * (PATCH /api/usuarios/:id/desbloqueo) — sin esto, CasbinGuard rechaza la
 * ruta con 403 aunque el rol sea ADMINISTRADOR. Mismo alcance que
 * activacion/inactivacion/reenviar/restauracion sobre el mismo recurso.
 */
export class casbinDesbloqueoUsuario1786500000000 implements MigrationInterface {
