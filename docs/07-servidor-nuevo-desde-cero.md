...
- **Pendiente**: corregir el valor real de esa política en el seed — no se adivinó el valor correcto (probablemente algo como `/perfil/foto` o una ruta real de subida de foto de perfil), queda para quien conozca la intención original de esa política.
